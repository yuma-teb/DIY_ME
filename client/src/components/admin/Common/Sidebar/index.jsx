    ...
    <Drawer anchor="left" open={isSidebarOpen} onClose={toggleSidebar} sx={{ zIndex: 3 }}>
      <div style={sideBarStyle}>
        <List>
          ...
          <ListItem button sx={hoverStyle} component={Link} to="/admin" onClick={toggleSidebar}>
            <ListItemIcon>
              <DashboardIcon />
            </ListItemIcon>
          ...
          <ListItem button onClick={handleUsersClick} sx={hoverStyle}>
            <ListItemIcon>
              <PeopleIcon />
            </ListItemIcon>
            <ListItemText primary="Users" />
            {isUsersOpen ? <ArrowRightIcon /> : <ArrowDropDownIcon />}
          </ListItem>
